...
import type { AgentOnboarding, AgentStatus, Permissions, Tenant } from '@/services/types';
...
export function AgentOnboardingTab({ agentOnboarding, tenants, permissions, onRefresh }: Props) {
